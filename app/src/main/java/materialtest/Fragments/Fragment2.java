package materialtest.Fragments;
...
import materialtest.Adapter.AdapterBoxOffice;
import materialtest.Interface.FilterInterface;
import materialtest.Interface.SearchInterface;
import materialtest.Interface.SortListener;
import materialtest.example.user.template.Plants;
import materialtest.example.user.template.R;
import materialtest.example.user.template.VolleySingleton;

import static materialtest.Interface.Keys.EndpointBoxOffice.KEY_COMMON;
import static materialtest.Interface.Keys.EndpointBoxOffice.KEY_CULTIVAR;
import static materialtest.Interface.Keys.EndpointBoxOffice.KEY_GENUS;
import static materialtest.Interface.Keys.EndpointBoxOffice.KEY_ID;
import static materialtest.Interface.Keys.EndpointBoxOffice.KEY_PLANTS;
import static materialtest.Interface.Keys.EndpointBoxOffice.KEY_SPECIES;

public class Fragment2 extends Fragment implements SortListener, SwipeRefreshLayout.OnRefreshListener, FilterInterface, SearchInterface {

    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private static final String STATE_PLANTS = "state plants";
    private static final String URL_BOX_OFFICE = "http://www.plantplaces.com/perl/mobile/viewplantsjson.pl";
    private static final String URL_CHAR_QUESTION = "?";
    private static final String URL_CHAR_AMPERSAND = "Combined_Name";
    private static final String URL_PARAM_LIMIT = "=";
