...
public class Item3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize toolbar
        final Toolbar toolbar = (Toolbar) findViewById(R.id.item3_toolbar);
        ...
        NavigationView mDrawer = (NavigationView) findViewById(R.id.item3_drawer);
