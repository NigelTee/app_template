...
public class Item2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize toolbar
        final Toolbar toolbar = (Toolbar) findViewById(R.id.item2_toolbar);
        ...
        NavigationView mDrawer = (NavigationView) findViewById(R.id.item2_drawer);
