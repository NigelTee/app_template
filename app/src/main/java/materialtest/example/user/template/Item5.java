...
public class Item5 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize toolbar
        final Toolbar toolbar = (Toolbar) findViewById(R.id.item5_toolbar);
        ...
        NavigationView mDrawer = (NavigationView) findViewById(R.id.item5_drawer);
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        return menuItem.getItemId() == R.id.navigation_item_5;
    }
